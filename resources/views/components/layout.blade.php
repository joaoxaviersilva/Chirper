...
<body class="relative flex min-h-screen flex-col bg-base-200 font-sans text-base-content">
    <div
        class="pointer-events-none absolute inset-x-0 top-0 h-80 bg-[radial-gradient(circle_at_top,_color-mix(in_oklab,var(--color-primary)_16%,transparent),_transparent_72%)]">
    </div>

    <nav class="navbar bg-base-100/90 px-4 backdrop-blur">
        <div class="navbar-start">
            <a href="{{ route('home') }}" aria-label="Go to the Chirper feed">
    ...
    <footer class="w-full mt-24">
        <div class="mx-auto w-full max-w-[1400px] px-4 xl:px-16">
            <svg class="block w-full h-auto text-base-content opacity-8" viewBox="0 0 1280 308" aria-hidden="true" focusable="false">
